/*
 * DeHub Stages voice effects — phase-vocoder pitch shifter (AudioWorklet).
 * Vendored verbatim from phaze by olvb: https://github.com/olvb/phaze
 * License: Unlicense (public domain). Registers "phase-vocoder-processor"
 * with a "pitchFactor" AudioParam (>1 up, <1 down). Peak-shifting phase
 * vocoder, 2048-sample block (~43ms latency). See src/hooks/use-voice-effects.ts.
 */
