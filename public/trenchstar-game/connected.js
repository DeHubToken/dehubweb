...
export function mountConnected(T){
  ...
  function request(body){return new Promise((resolve,reject)=>{
    ...
    else {clearTimeout(timer);waiting.delete(key);reject(new Error('Open Chartopia from the DeHub arcade to connect your account.'));}
  });}
