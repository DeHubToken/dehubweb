...
The current gateway excludes its own settlement asset (Base USDC) from the
1Click catalogue. It does not promise every token on every NEAR-supported chain.
