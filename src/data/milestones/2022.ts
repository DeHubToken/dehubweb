...
**Doing it properly still beats not doing it.** The regulatory work carried on regardless, and the pattern held: real registrations, real obligations, everything on the record. The Palawan venture failed on its merits, in the open, rather than collapsing into a legal problem — which is a meaningfully better way to lose.
...
The same instinct shaped everything else set up that quarter — real structures carrying real compliance obligations, rather than the loose arrangements a lot of projects were still operating under in 2022.
