/**
 * Minimal ZIP writer (store only, no compression) for bundling page exports.
 * PNG and JPG are already compressed, so deflate would buy nothing, and this
 * avoids adding a zip dependency for one button.
 */
const CRC_TABLE = (() => {
