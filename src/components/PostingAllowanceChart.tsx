...
const TIERS: AllowanceTier[] = [
  ...
  { name: 'Crab', threshold: '10,000+', postsPerDay: 11, gbPerDay: 1.1, dhbPerTextPost: 95, dhbPerGb: 1900, image: '/media/60bc125c-8efd-4058-9e12-7ca393df4fce.png' },
  { name: 'Lobster', threshold: '25k+', postsPerDay: 12, gbPerDay: 1.2, dhbPerTextPost: 93, dhbPerGb: 1860, image: '/media/2c7200c2-681e-4499-863b-ea24fdbdb70c.png' },
  { name: 'Piranha', threshold: '50k+', postsPerDay: 13, gbPerDay: 1.3, dhbPerTextPost: 91, dhbPerGb: 1820, image: '/media/38387f75-fd38-4380-9588-1f19f68d8435.png' },
  { name: 'Tortoise', threshold: '100k+', postsPerDay: 14, gbPerDay: 1.4, dhbPerTextPost: 89, dhbPerGb: 1780, image: '/media/fc47a759-390a-4f41-ba96-5bc0066e82b9.png' },
  { name: 'Cobra', threshold: '250k+', postsPerDay: 15, gbPerDay: 1.5, dhbPerTextPost: 87, dhbPerGb: 1740, image: '/media/b3306c99-31b8-4bfc-bc25-f73abc68fc38.png' },
  { name: 'Octopus', threshold: '500k+', postsPerDay: 16, gbPerDay: 1.6, dhbPerTextPost: 85, dhbPerGb: 1700, image: '/media/8fcbb3f6-223d-4e2f-9d82-30082a175491.png' },
  { name: 'Crocodile', threshold: '1m+', postsPerDay: 17, gbPerDay: 1.7, dhbPerTextPost: 83, dhbPerGb: 1660, image: '/media/c84eee0a-97c7-4938-9b9c-c991c802593e.png' },
  { name: 'Dolphin', threshold: '2m+', postsPerDay: 18, gbPerDay: 1.8, dhbPerTextPost: 81, dhbPerGb: 1620, image: '/media/4558c158-75d9-40fc-adfa-41125344a48e.png' },
  { name: 'Tiger Shark', threshold: '3m+', postsPerDay: 19, gbPerDay: 1.9, dhbPerTextPost: 79, dhbPerGb: 1580, image: '/media/6be493f1-51b4-481b-9ca1-340c030b2ef8.png' },
  { name: 'Killer Whale', threshold: '5m+', postsPerDay: 20, gbPerDay: 2, dhbPerTextPost: 77, dhbPerGb: 1540, image: '/media/fcc288eb-67d7-49a0-b561-94bb5d1b8896.png' },
  { name: 'Great White Shark', threshold: '10m+', postsPerDay: 25, gbPerDay: 2.5, dhbPerTextPost: 75, dhbPerGb: 1500, image: '/media/dfcc3420-f654-486b-bc94-f84f0209ba5c.png' },
  { name: 'Blue Whale', threshold: '25m+', postsPerDay: 50, gbPerDay: 5, dhbPerTextPost: 73, dhbPerGb: 1460, image: '/media/bc6b4bb7-aa43-4015-adb0-194568cc0858.png' },
  { name: 'Megalodon', threshold: '50m+', postsPerDay: 100, gbPerDay: 10, dhbPerTextPost: 70, dhbPerGb: 1400, image: '/media/9282e1c6-fa68-4b7c-b3cd-22d860df35af.png' },
];
