...
export const HeroTitle = ({
  ...
  return (
    <motion.h1
      className={`font-exo text-[3.2rem] sm:text-5xl md:text-7xl lg:text-8xl font-bold uppercase tracking-wider text-white md:scale-[1.15] lg:scale-110 translate-y-[30px] sm:translate-y-0 ${masterGlitch ? 'glitch-active' : ''} ${className}`}
