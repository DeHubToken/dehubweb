...
export const HeroTitle = ({
  ...
  return (
    <motion.h1
      className={`font-exo text-[3.61rem] sm:text-[2.85rem] md:text-[4.275rem] lg:text-[5.7rem] font-bold uppercase tracking-wider text-white md:scale-[1.15] lg:scale-110 ${masterGlitch ? 'glitch-active' : ''} ${className}`}
