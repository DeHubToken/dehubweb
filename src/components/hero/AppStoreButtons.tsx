...
const GooglePlayIcon = () => (
  <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-5 md:h-5 shrink-0" fill="none">
...
// Apple logo
const AppleIcon = () => (
  <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-5 md:h-5 shrink-0" fill="white">
...
export const AppStoreButtons = () => {
  ...
  return (
    <motion.div 
      ...
      initial="hidden" 
      animate="visible" 
      className="mt-6 -translate-y-[30px] md:translate-y-0 flex flex-col sm:flex-row justify-center items-center gap-3"
    >
      <a
        ...
        style={cursorStyle}
      >
        <LiquidGlassBubble shimmer className={`px-6 py-2.5 md:px-5 md:py-2 cursor-pointer ${glassOverride}`}>
