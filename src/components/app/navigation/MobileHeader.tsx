      ...
      <div className="flex items-center gap-3">
        ...
        {isAuthenticated && (
          ...
          >
            ...
            {totalNotifUnread > 0 && (
              <span className="absolute -top-1.5 -right-1.5 min-w-[20px] h-[20px] px-1 inline-flex items-center justify-center bg-red-500 text-white text-[11px] font-bold rounded-full" style={{ lineHeight: '20px', paddingTop: '1px' }}>
