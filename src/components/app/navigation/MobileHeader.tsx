      ...
      <div className="flex items-center gap-3">
        ...
        {isAuthenticated && (
          ...
          >
            ...
            {totalNotifUnread > 0 && (
              <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 grid place-items-center bg-red-500 text-white text-[10px] font-bold rounded-full leading-none">
