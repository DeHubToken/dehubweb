...
const NAV_LABEL_KEYS: Record<string, string> = {
  ...
  'Command': 'nav.command', 'Command Centre': 'nav.commandCentre', Wallet: 'nav.wallet', Docs: 'nav.docs', 'Feature Requests': 'nav.featureRequests', Governance: 'nav.governance', Careers: 'nav.careers', Glossary: 'nav.glossary',
};
