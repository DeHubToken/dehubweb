...
export function DesktopSidebar({ onPostClick }: DesktopSidebarProps) {
  ...
  return (
    <>
      <aside className={cn(
        "hidden lg:flex sticky top-0 h-screen px-2 pt-[2px] pb-2 flex-col overflow-hidden items-center transition-[width,padding,margin] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] z-0 isolate",
        isCollapsed ? "w-[60px]" : "w-[60px] xl:w-[231px] xl:px-[18px] xl:items-stretch"
      )}>
        {/* Logo & Coin Balance */}
