  ...
  return (
    <>
      <aside className="hidden lg:flex sticky top-0 h-screen w-[60px] xl:w-[231px] px-2 xl:px-[18px] pt-[2px] pb-2 flex-col overflow-y-auto scrollbar-invisible items-center xl:items-stretch transition-all duration-200">
        ...
        {/* Navigation Bento */}
        <div className="-mt-[8.5px] rounded-2xl p-1 xl:p-2.5 space-y-2 xl:space-y-[2px] flex flex-col items-center xl:items-stretch bg-gradient-to-tl from-white/20 via-white/10 to-white/5 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
