  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-zinc-900 rounded-2xl overflow-hidden group cursor-pointer hover:ring-2 hover:ring-blue-500/50 transition-all">
            <div className="aspect-video bg-zinc-800 relative">
              <div className="absolute top-2 right-2 bg-blue-500 text-black text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1">
