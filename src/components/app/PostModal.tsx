    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] p-0 bg-black border-zinc-800 overflow-hidden">
            ...
            <div className="flex-1 min-w-0">
                          ...
                          <div className="relative">
                            ...
                            {m.duration && (
                              <div className="absolute bottom-2 left-2 bg-black/70 px-2 py-0.5 rounded text-xs text-white">
                                ...
                                {m.duration < 90 && (
                                  <span className="ml-1 text-emerald-400">• Short</span>
                                )}
                              </div>
                            )}
                          </div>
              ...
              <AnimatePresence>
                {isLive && (
                  <motion.div
                    ...
                    className="mt-3 p-4 bg-red-500/10 border border-red-500/30 rounded-xl flex items-center gap-3"
                  >
                    <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse" />
                    <span className="text-red-400 font-medium">Live stream will be created</span>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <AnimatePresence>
                {canPost && (
                  ...
                  >
                    <span className="text-xs text-zinc-500">Will appear in:</span>
        ...
        <div className="px-4 py-3 border-t border-zinc-800 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              title="Add video"
            >
              <Film className="w-5 h-5 text-purple-400 group-hover:text-purple-300" />
            </button>
            ...
            <button
              ...
              title="Go live"
            >
              <Radio className={cn("w-5 h-5", isLive ? "text-red-500" : "text-red-400 hover:text-red-300")} />
            </button>
            ...
            <button
              ...
              title="Bold"
            >
              <Bold className="w-4 h-4 text-zinc-400 hover:text-zinc-300" />
            </button>
            ...
            <button
              ...
              title="Italic"
            >
              <Italic className="w-4 h-4 text-zinc-400 hover:text-zinc-300" />
            </button>
            ...
            <button
              ...
              title="Mention"
            >
              <AtSign className="w-4 h-4 text-zinc-400 hover:text-zinc-300" />
            </button>
            ...
            <button
              ...
              title="Location"
            >
              <MapPin className="w-4 h-4 text-zinc-400 hover:text-zinc-300" />
            </button>
          </div>
        ...
        <div className="px-4 pb-3 flex justify-end">
          <span className={cn(
            "text-xs",
            text.length > 280 ? "text-amber-400" : "text-zinc-500"
          )}>
            {text.length}/280
          </span>
        </div>
