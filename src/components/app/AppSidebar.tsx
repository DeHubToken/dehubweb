    ...
    <>
      ...
      {!isAuthenticated && (
        <div className="mb-4 pb-4 px-1">
          <LiquidGlassBubble data-login-button shimmer noBorder className="w-full box-border cursor-pointer border border-white/30 rounded-2xl" onClick={() => setIsPostModalOpen(true)}>
