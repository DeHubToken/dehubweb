...
export const RightSidebar = memo(function RightSidebar({ showSearch = true }: RightSidebarProps) {
  ...
  return (
    <aside className={cn("hidden lg:block w-80 xl:w-88 h-screen sticky top-0 pt-[10px] pb-4 overflow-y-auto scrollbar-hide relative z-10 isolate transition-[padding] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]", isCollapsed ? "pl-0 pr-2" : "px-4")}>
