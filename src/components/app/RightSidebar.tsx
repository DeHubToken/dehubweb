  ...
  return (
    <div className="relative">
      ...
      <Input
        ...
        placeholder="Search..."
        className="w-full pl-10 bg-zinc-900 border-0 rounded-2xl text-white placeholder:text-zinc-500 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 h-[38px]"
      />
    </div>
  );
}
