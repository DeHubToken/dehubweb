...
import { 
  ...
  Megaphone, PartyPopper, Drum, Bug, Laugh, Sparkles, User, Ghost, Wand2, VolumeX as VolumeXIcon,
...
const BUILT_IN_EFFECTS: BuiltInEffect[] = [
  ...
  { id: 'shhh', label: 'Shhh', icon: <VolumeXIcon className="w-4 h-4" />, frequency: 0, type: 'sine', duration: 2000 },
];
