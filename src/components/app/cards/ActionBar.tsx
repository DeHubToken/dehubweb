  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-between">
        {/* Primary actions */}
        <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 xl:gap-4 min-w-0">
          <motion.button 
          ...
          >
            <ThumbsUp className={cn("w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px] xl:w-5 xl:h-5", isLiked && "fill-current")} />
            <span className="text-[9px] sm:text-[10px] lg:text-xs text-zinc-400">{formatCount(localLikeCount)}</span>
          </motion.button>
          {!hideDislike && (
            <motion.button 
              ...
              transition={{ duration: 0.3, ease: "easeOut" }}
            >
              <ThumbsDown className={cn("w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px] xl:w-5 xl:h-5", isDisliked && "fill-current")} />
              <span className="text-[9px] sm:text-[10px] lg:text-xs text-zinc-400">{formatCount(localDislikeCount)}</span>
            </motion.button>
          )}
          <button 
            onClick={onComment}
            ...
            aria-label="Comment"
          >
            <MessageSquare className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px] xl:w-5 xl:h-5" />
            <span className="text-[9px] sm:text-[10px] lg:text-xs text-zinc-400">{formatCount(commentCount)}</span>
          </button>
          ...
          <button 
            ...
            aria-label="Repost"
          >
            <Repeat2 className="w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 xl:w-[22px] xl:h-[22px]" />
            <span className="text-[9px] sm:text-[10px] lg:text-xs text-zinc-400">{formatCount(displayRepostCount)}</span>
          </button>
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 lg:gap-3">
          ...
          >
            <Bookmark className={cn("w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px] xl:w-5 xl:h-5", isBookmarked && "fill-current")} />
          </motion.button>
          <button 
          ...
          >
            <Info className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-[18px] lg:h-[18px] xl:w-5 xl:h-5" />
          </button>
        </div>
      </div>
    </div>
