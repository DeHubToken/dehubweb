    ...
    <div className="flex flex-col items-center gap-1 flex-shrink-0 cursor-pointer -ml-[7.5px]">
      <div className="p-px rounded-xl bg-gradient-to-br from-red-500 via-red-600 to-orange-500">
        <div className="p-px bg-zinc-900 rounded-xl">
          <div className="w-[65px] h-[65px] rounded-[10px] bg-zinc-900/50 backdrop-blur-sm flex items-center justify-center">
                ...
                {item.type === 'story' ? (
                  <div className="p-px rounded-xl bg-gradient-to-br from-red-500 via-red-600 to-orange-500">
                    <div className="p-px bg-zinc-900 rounded-xl">
                      ...
                      {item.thumbnail ? (
                        <div className="w-[65px] h-[65px] rounded-[10px] overflow-hidden">
                          <img 
                            src={item.thumbnail} 
                            alt={item.name}
                        ...
                        <Avatar className="w-[65px] h-[65px] rounded-[10px]">
