  ...
  return (
    ...
    >
      ...
      <div 
        ...
        tabIndex={0}
        data-no-navigate
        className={`relative bg-zinc-800 cursor-pointer group/thumb outline-none rounded-md overflow-hidden border border-white/[0.08] ${isFullscreen ? 'w-full h-full flex items-center justify-center' : 'aspect-video'}`}
