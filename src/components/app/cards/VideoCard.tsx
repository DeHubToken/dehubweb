  ...
  return (
    ...
    >
      ...
      <div 
        ...
        tabIndex={0}
        data-no-navigate
        className={`relative bg-zinc-800 cursor-pointer group/thumb outline-none rounded-md overflow-hidden transition-all duration-300 ${!showControls && isPlaying ? 'cursor-none' : ''} ${isFullscreen ? 'fixed inset-0 z-[9999] w-screen h-screen rounded-none flex items-center justify-center' : (isImmersive && showComments ? 'aspect-[2/1]' : 'aspect-video')}`}
