                ...
                <div className="text-center p-4">
                    ...
                    >
                        ...
                        <button
                            ...
                            className="transition-transform hover:scale-105 -translate-y-[20px] md:translate-y-0"
                            style={{ cursor: 'url("data:image/svg+xml,%3Csvg width=\'12\' height=\'12\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Crect width=\'12\' height=\'12\' fill=\'white\' fill-opacity=\'0.9\' /%3E%3C/svg%3E") 6 6, auto' }}
                        >
                            <img 
                                src={appStoreBadge} 
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="mt-8 ml-[7px] flex items-center justify-center gap-6"
                    >
                        {[
                    ...
                    <motion.div
                        ...
                        className="mt-8 flex justify-center translate-y-[180px] md:translate-y-[2px]"
                    >
                        <img 
                            src={dehubLogo} 
                            alt="DeHub Logo" 
