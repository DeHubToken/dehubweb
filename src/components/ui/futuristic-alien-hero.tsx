    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-black scanline-overlay" style={{ cursor: 'url("data:image/svg+xml,%3Csvg width=\'12\' height=\'12\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Crect width=\'12\' height=\'12\' fill=\'white\' fill-opacity=\'0.9\' /%3E%3C/svg%3E") 6 6, auto' }}>
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden z-10">
                <div className="text-center p-4">
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="mt-8 ml-[7px] md:ml-[12px] flex items-center justify-center gap-6 -translate-y-[20px] md:translate-y-0"
                    >
                        {[
            ...
            <motion.div
                ...
                className="absolute bottom-[20px] left-[calc(50%-13px)] -translate-x-1/2 z-20"
            >
                <img 
                    src={dehubLogo} 
                    alt="DeHub Logo" 
