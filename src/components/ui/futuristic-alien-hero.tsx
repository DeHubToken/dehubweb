            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden z-10">
                <div className="text-center p-4 -translate-y-[40px] md:translate-y-0">
                    ...
                    <motion.div 
                        ...
                        initial="hidden" 
                        animate="visible" 
                        className="mt-8 -translate-y-[45px] md:translate-y-0 md:-ml-[18px] flex flex-col sm:flex-row justify-center items-center gap-4 scale-[1.15] md:scale-100"
                    >
                        <a
                        ...
                        >
                            <img 
                                ...
                                className="h-[83.64px] md:h-[43.56px] w-auto"
                                style={{
                                    filter: 'drop-shadow(0 0 12px rgba(255, 255, 255, 0.5))'
                                }}
                            />
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="mt-8 ml-[-5px] md:ml-0 flex items-center justify-center gap-6 -translate-y-[20px] md:translate-y-0 scale-[1.15] md:scale-[1.18]"
                    >
                        {[
