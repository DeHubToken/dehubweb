    ...
    useEffect(() => {
        ...
        featuredBuzzwords.forEach(word => {
            ...
            if (sprite) {
                ...
                sprite.scale.set(size * 2.875 * 0.9, size * 0.71875 * 0.9, 1); // 10% smaller than background
                scene.add(sprite);
                textSprites.push(sprite);
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden z-10">
                <div className="text-center p-4">
                    ...
                    >
                        ...
                        <motion.span variants={fadeUpVariants} custom={1.5} initial="hidden" animate="visible" className="block mt-[0.4rem] md:mt-4">
