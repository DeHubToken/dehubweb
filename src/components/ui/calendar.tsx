    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-white/10 border-white/10 p-0 opacity-70 hover:opacity-100 hover:bg-white/20 text-white",
        ),
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal text-white/80 hover:bg-white/10 hover:text-white aria-selected:opacity-100"),
        day_range_end: "day-range-end",
        day_selected:
          "!bg-white !text-black hover:!bg-white/90 hover:!text-black focus:!bg-white focus:!text-black font-semibold",
        day_today: "bg-white/15 text-white font-semibold",
        day_outside:
          "day-outside text-white/20 opacity-50 aria-selected:bg-white/10 aria-selected:text-white/40 aria-selected:opacity-30",
