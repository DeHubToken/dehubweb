      ...
      <div className="space-y-12">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/docs/overview" className="inline-flex items-center justify-center min-w-[180px] px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all duration-200 font-exo">
              {t('common.getStarted')}
            </Link>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to={`/guides/${latestPost.slug}`} className="flex justify-center sm:inline-flex sm:items-center px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all duration-200 font-exo text-center">
        ...
        {/* Getting Started */}
        <div className="rounded-2xl p-8 text-center border border-border bg-muted">
          <h2 className="text-3xl font-bold mb-4 font-exo text-foreground">{t('home.readyToGetStarted')}</h2>
          <p className="mb-6 max-w-2xl mx-auto font-exo text-muted-foreground">
            {t('home.readyDescription')}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/docs/quickstart" className="inline-flex items-center px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all duration-200 font-exo">
