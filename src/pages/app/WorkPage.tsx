          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              >
                ...
                <span className="hidden md:inline">{t('work.myBounties')}</span>
              </button>
              <LiquidGlassBubble2
                label={t('work.postBounty')}
          ...
          <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
            {TABS.map((tabItem) => {
              ...
              return (
                ...
                >
                  <ThemedIcon icon={tabItem.icon} alt="" className="w-4 h-4 object-contain" /> {t(tabItem.labelKey)}
                </button>
              );
            })}
          </div>
        ...
        {isLoading ? (
          ...
          <div>
            <div className="text-center py-16 text-white/50">
              ...
              <p className="mb-4">
                {hasFilters ? t('work.emptyFiltered') : t('work.emptyNone')}
              </p>
