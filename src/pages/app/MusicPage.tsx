...
export default function MusicPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub Music — Decentralised Social Media, Censorship Resistant & Freedom of Speech</h1>
      {/* Tab Navigation */}
