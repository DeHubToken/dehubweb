...
export default function CommandCentrePage() {
  ...
  return (
    <div className="px-2 pt-1 pb-2 sm:px-3 sm:pt-1 sm:pb-3 lg:pt-2 min-h-screen">
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub Command — Decentralised Social Media, Censorship Resistant & Freedom of Speech</h1>
