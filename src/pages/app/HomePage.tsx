...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub Home — Decentralised Social Media Feed, Censorship Resistant & Freedom of Speech</h1>
      {/* Tab Navigation */}
