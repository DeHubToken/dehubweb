...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Tab Navigation */}
      <div
        className={cn("sticky top-[66px] lg:top-[22px] bg-black z-50 px-2 pt-1 pb-2 sm:px-3 sm:pt-1 sm:pb-3 lg:pt-2 lg:mt-0 transition-transform duration-300 ease-in-out", isCollapsed && "pl-2 pr-0", isCollapsed && "lg:hidden")}
