...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Tab Navigation */}
      <div
        className={cn("sticky top-11 lg:top-0 bg-black z-[110] pt-1 pb-2 sm:pt-1 sm:pb-3 lg:px-3 lg:pt-2 lg:mt-0 transition-transform duration-300 ease-in-out", isCollapsed && "lg:pl-2 lg:pr-0", isCollapsed && "lg:hidden")}
        style={{ transform: (isMobile && !navVisible) ? 'translateY(calc(-100% - 3rem))' : 'translateY(0)', willChange: 'transform' }}
      >
        <div className="bg-zinc-900 overflow-visible rounded-none lg:rounded-xl">
