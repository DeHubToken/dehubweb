...
export default function AgentsPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub AI Agents — Decentralised Social Media, Censorship Resistant & Freedom of Speech</h1>
