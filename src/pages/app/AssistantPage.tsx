...
export default function AssistantPage() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-[69px] md:bottom-[70px] left-0 right-0 px-2 z-40 lg:bottom-4 lg:left-auto lg:right-auto lg:px-4 lg:w-full lg:max-w-4xl lg:mx-auto lg:relative lg:z-auto lg:-translate-y-[0.4px]">
