...
export default function FeaturesPage() {
  ...
  return (
    <div className="min-h-screen px-2 pt-1 pb-2 sm:px-3 sm:pt-1 sm:pb-3 lg:pt-2">
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub Features — Decentralised Social Media, Censorship Resistant & Freedom of Speech</h1>
      {/* Header */}
