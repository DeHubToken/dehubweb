...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen p-3 sm:p-4">
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub Careers — Decentralised Social Media, Censorship Resistant & Freedom of Speech</h1>
      {/* Header bento */}
