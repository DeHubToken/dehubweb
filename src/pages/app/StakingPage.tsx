...
import { Lock, TrendingUp, DollarSign, Activity, ExternalLink, RefreshCw, ArrowDownToLine, ArrowUpFromLine, Loader2, Clock, Gift, Wallet, AlertTriangle, Percent, Zap, Crown, Rocket, X } from 'lucide-react';
      ...
      >
        ...
        <div className="p-5 columns-1 sm:columns-2 gap-4 space-y-4">
          ...
          <div className="break-inside-avoid rounded-xl border border-white/10 bg-white/[0.04] p-4 space-y-3">
            ...
            <div className="space-y-1 max-h-[10.6rem] overflow-y-auto pr-1">
