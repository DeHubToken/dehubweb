...
export default function GlossaryPage() {
  ...
  return (
    <div className="px-2 pt-1 pb-6 sm:px-3 sm:pt-1 sm:pb-6 lg:pt-2 min-h-screen">
      ...
      <h1 className="text-xs text-zinc-500 mb-2 px-3 sm:px-4 pt-2 font-medium">DeHub Glossary — Decentralised Social Media, Censorship Resistant & Freedom of Speech</h1>
      {/* Header */}
