-- lovable-cron-fallback-reviewed: 144 runs/day; time-based vote closing, deadline reminders and 72-hour payment expiry must resolve within 10 minutes of their deadline; no row change triggers them
...
-- Eligibility and weight are a snapshot taken when the proposal opens.
...
GRANT ALL ON public.dao_proposals, public.dao_proposal_voters, public.dao_proposal_votes
  TO service_role;
